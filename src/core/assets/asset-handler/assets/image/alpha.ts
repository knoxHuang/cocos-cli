...
export const AlphaImageHandler: AssetHandler = {
    ...
    importer: {
        ...
        async import(asset: VirtualAsset) {
            ...
            const source = utils.Path.resolveToRaw(parent.userData.alpha);
            ...
            await saveImageAsset(asset, imageDataBufferOrimagePath, '.png', 'alpha');
            await importWithType(asset, parent.userData.type, 'alpha', parent.extname);
            return true;
        },
    },
};

export default AlphaImageHandler;
